...
<body>
    ...
    <form action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method = "POST">
          <br><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tickettaddmodal">
                        ADD TICKET
                    </button><br>
...
<?php 
 ...
 <!-- Modal -->
    <div class="modal fade" id="tickettaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <form action="insertcode.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class ="form-control" name="txtdescription" rows="6" cols="50"></textarea>
                        </div>
