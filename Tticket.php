...
<head>
    ...
    <title> AUIT Ticket Management System </title>
...
<body>
    ...
    <div class="container">
        <div class="jumbotron bg-dark">
            ...
            <div class="card">
                <div class="card-body">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tickettaddmodal">
                        ADD TICKET
                    </button><br>
            ...
            <div class="card">
                ...
                ?>
                    <table id="datatableid" class="table table-bordered table-primary table-striped">
                        <thead>
                            <tr>
            ...
            ?>
                        <tbody>
                            <tr>
                                ...
                                <td style="display:none;"><?php echo $row['details']; ?> </td></td>
                                <td>
                                    <button type="button" class="btn btn-info viewbtn "> Details </button>
                                </td>
                                <td>
